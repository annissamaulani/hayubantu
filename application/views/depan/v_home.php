...
<head>
    ...
    <title>Desa Gunasari - Selamat Datang di Desa Gunasari</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
               ...
               <p>Website ini merupakan website Sistem Informasi Desa yang berguna untuk melihat informasi desa dan untuk mempromosikan pariwisata yang ada di desa Gunasari</p>
...
<!--//END ABOUT -->
<!--============================= OUR COURSES =============================-->
<section class="our_courses text-center">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
          <?php foreach ($berita->result() as $row) :?>
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div class="courses_box mb-6">
                    <div class="course-img-wrap">
                        <img src="<?php echo base_url().'assets/images/'.$row->tulisan_gambar;?>" class="img-fluid" alt="courses-img">
                    </div>
                    <!-- // end .course-img-wrap -->
                    <a href="<?php echo site_url('artikel/'.$row->tulisan_slug);?>" class="course-box-content">
                        <p style="text-align:center;"><b><?php echo $row->tulisan_judul;?></b></p>
                    </a>
                    <div class="col-12 text-center">
                        <a href="<?php echo site_url('artikel/'.$row->tulisan_slug);?>" class="btn btn-warning btn-xs">View More</a>
                    </div>
                </div>
            </div>
          <?php endforeach;?>
...
<section class="container text-center">
    <div class="container">
        ...
        <div class="row">
          <?php foreach ($wisata->result() as $row) :?>
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div class=" mb-6">
                    <div class="course-img-wrap">
                        <img src="<?php echo base_url().'assets/images/pariwisata/'.$row->pariwisata_gambar;?>" class="img-fluid" alt="courses-img">
                    </div>
                    <!-- // end .course-img-wrap -->
                    <a href="<?php echo site_url('pariwisata/'.$row->pariwisata_slug);?>" class="course-box-content">
                        <p style="text-align:center;"><b><?php echo $row->pariwisata_judul;?></b></p>
                    </a>
                    <div class="col-12 text-center">
                        <a href="<?php echo site_url('pariwisata');?>" class="btn btn-warning btn-xs">View More</a>
                    </div>
                </div>
            </div>
          <?php endforeach;?>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <a href="<?php echo site_url('pariwisata');?>" class="btn btn-default btn-courses">View More</a>
            </div>
        </div>
    </div>
    <br><br><br>
