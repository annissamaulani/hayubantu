        ...
        <div class="row">
            <div class="col-md-8">
                <div class="blog-img_block">
                    <img src="<?php echo base_url().'assets/images/umkm/'.$image?>" class="img-fluid" alt="blog-img">
                    <div class="blog-date">
                        <span><?php echo $tanggal;?></span>
                    </div>
                </div>
                <div class="blog-tiltle_block">
                    <h4><a href="<?php echo site_url('umkm/'.$slug);?>"><?php echo $title;?></a></h4>
                    ...
                    <div class="blogpost-tabs">
                        ...
                        <div class="tab-content">
                              ...
                              <?php
                                ...
                                <div class="row">
                                  ...
                                  <?php
                					            ...
                					            $query=$this->db->query("SELECT * FROM tbl_komentar_umkm WHERE komentar_status='1' AND komentar_parent='$komentar_id' ORDER BY komentar_id ASC");
                            ...
                            <div class="tab-pane" id="write-comment" role="tabpanel">
                                <form action="<?php echo site_url('umkm/komentar');?>" method="post">
                                    <div class="row">
                                        <div class="col-6">
