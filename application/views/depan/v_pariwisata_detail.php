        ...
        <div class="row">
            <div class="col-md-8">
                <div class="blog-img_block">
                    <img src="<?php echo base_url().'assets/images/pariwisata/'.$image?>" class="img-fluid" alt="blog-img">
                    <div class="blog-date">
                        <span><?php echo $tanggal;?></span>
                    </div>
                </div>
                <div class="blog-tiltle_block">
                    <h4><a href="<?php echo site_url('pariwisata/'.$slug);?>"><?php echo $title;?></a></h4>
                    ...
                    <div class="blogpost-tabs">
                        ...
                        <div class="tab-content">
                              ...
                              <?php
                                ...
                                <div class="row">
                                  ...
                                  <?php
                                                ...
                                                $query=$this->db->query("SELECT * FROM tbl_komentar_pariwisata WHERE komentar_status='1' AND komentar_parent='$komentar_id' ORDER BY komentar_id ASC");
                            ...
                            <div class="tab-pane" id="write-comment" role="tabpanel">
                                <form action="<?php echo site_url('pariwisata/komentar');?>" method="post">
                                    <div class="row">
                                        <div class="col-6">
                ...
                <div class="blog-featured_post">
                  ...
                  <?php foreach ($populer->result() as $row) :?>
                    <div class="blog-featured-img_block">
                        <img width="35%" src="<?php echo base_url().'assets/images/pariwisata/'.$row->pariwisata_gambar;?>" class="img-fluid" alt="blog-featured-img">
